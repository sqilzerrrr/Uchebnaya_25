  ...
  return (
    <div className='kartinka'>
        ...
        <div className='p-25 30'>
          ...
          <div>
            <button id='vv' className='w-140 h-20 rounded-3xl text-2xl font-normal text-stone-50 bg-green-300  pb-1.5 cursor-pointer transform-gpu hover-opacity-100 ml-6 mt-20'>оставить заявку</button>
          </div>
        </div>
    </div>
  )
